					...
					return (
						...
						>
							<div className="relative w-full h-full transition-transform duration-700 transform-style preserve-3d group-hover:rotate-y-180">
								...
								{/* Back Card */}
								<div className="absolute inset-0 backface-hidden rotate-y-180 text-white rounded-2xl shadow-2xl border border-purple-400/30 backdrop-blur-sm">
									<div className="flex flex-col h-full p-6">
										...
										<div className="flex justify-between items-center gap-6 ">
											...
											{/* Date on the right */}
											<div className="flex items-center gap-2 p-3 rounded-xl backdrop-blur-sm bg-white/10 hover:bg-white/15 transition-all duration-300">
